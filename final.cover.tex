...
\bigskip\noindent \hfill {\large {\bf BIOLOGY 3SS3}, C01, Version \testver} \hspace*{\fill} \\
...
\item On side 1 (red side) of the form, in the top box, in pen, print your student number (NOTE: 9 digits), name, course name, section number, instructor name and date in the spaces provided.  Then you MUST write your signature in the space marker SIGNATURE.
